...
public class DroneBehaviour_FB : MonoBehaviour
{
    [Tooltip("Maximum distance to sway along the initial local Z axis")]
    ...
    void Awake()
    {
        // cache the starting center and the initial local Z axis
        startPos = transform.position;
        swayAxis = transform.forward;
    }
    ...
    void Update()
    {
        ...
        // Sway forward–back along the fixed swayAxis
